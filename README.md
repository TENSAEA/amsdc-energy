...
python experiments/scripts/e23_opposition.py    # better-student / worse-cascade (Table 12)
python experiments/scripts/e27_compare_students.py sst2 \
    plain20k=experiments/results/e21_d20k_sst2.json \
    cad_g1=experiments/results/e21_cad_g1_sst2.json   # complement-aware distillation (Table 13)
```
